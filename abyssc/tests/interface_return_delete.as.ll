; ModuleID = '/home/xator/Abyss/abyssc/tests/interface_return_delete.as'
source_filename = "/home/xator/Abyss/abyssc/tests/interface_return_delete.as"
...
entry:
  ...
  store i32 %iface.call, ptr %result, align 4
  %del_ptr = load ptr, ptr %readable, align 8
  call void @free(ptr %del_ptr)
  %load3 = load i32, ptr %result, align 4
  ret i32 %load3
}
